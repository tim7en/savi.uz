...
<style>
:root{{--bg:#eef2f0;--paper:#fbfcfb;--ink:#13201d;--muted:#53635f;--faint:#788783;--line:#ccd7d3;--teal:#087f72;--blue:#356da6;--brick:#b84138;--soft:#dcefea;--warn:#f4dedb;--mono:"Cascadia Mono",Consolas,monospace;--serif:Georgia,"Times New Roman",serif;--sans:system-ui,-apple-system,"Segoe UI",sans-serif}}
...
<section><div class="eyebrow">VII · Personal dividends</div><h2>Separate spending cash from rescue cash.</h2>
