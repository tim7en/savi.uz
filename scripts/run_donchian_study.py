"""Compare rolling 5/10-bar Donchian breaks across relative-volume floors.
...
def main(argv: list[str] | None = None) -> int:
    ...
    lines = [
        ...
        f"Rolling bar windows: **{', '.join(map(str, args.windows))}**; "
        f"chronological split: **{args.split}**.", "",
        "The channel uses completed earlier bars in the same session only. A breakout is observed at a bar close and",
        ...
        "| Bars | Vol floor | Period | n | Mean R | PF | Target | Sustainable | Outside 60m | Re-enter 30m | Whipsaw 30m | Median MFE |",
        "|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
    ]
    ...
    for window in args.windows:
        for floor in args.volume_floors:
            ...
            for direction, label in ((1, "long"), (-1, "short")):
                ...
                print(
                    f"{window:>2}b {floor:>4.2f}x test {label:<5} n={summary.count:>3} "
