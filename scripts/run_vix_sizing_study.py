"""Market-wide volatility as a sizing input, tested for redundancy with N.
...
def main(argv=None) -> int:
    ...
    for sessions in args.ma_sessions:
        ...
        arms = {
            ...
            f"VIX tilt only ({low:g}x when VIX high)": vix_tilt,
            "VIX tilt reversed (half when calm)": lambda t: vix_tilt(t, reverse=True),
            "MA and VIX combined": both,
        }
