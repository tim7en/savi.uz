...
| [`quality-ladder-cape-leverage.html`](quality-ladder-cape-leverage.html) | CAPE-conditioned 3x/2x/1x leverage on the 80% SPY core, with annual/triennial contributions and the existing quality/Treasury ladder; includes P&L, wealth, drawdown, CAPE-regime, funding-cost and control comparisons. | Local backtest page |
