...
| [`the-median-was-the-signal.html`](the-median-was-the-signal.html) | Margin of safety measured: drawdown alone fails and fails backwards, quality screens do not rescue it at two months, and at three years quality orders the median while the mean stays hostage to junk tails. | [artifact](https://claude.ai/code/artifact/d32675e0-0447-4485-add7-409285ec8558) |
