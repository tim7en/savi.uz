...
|---|---|---|
| [`where-the-market-is-not-efficient.html`](where-the-market-is-not-efficient.html) | **Start here.** All 31 proposals sorted by what they tried to do, each with the control that decided it. | [artifact](https://claude.ai/code/artifact/128d4a7d-84dd-46a1-b03b-0031f36a52ea) |
...
| [`six-proposals-one-survivor.html`](six-proposals-one-survivor.html) | Seven proposals in one sitting — ML filter, 3:1 scalp, S/R zones, 20x leverage, volatility surprise, option activity, earnings drift. | [artifact](https://claude.ai/code/artifact/4e10691c-e699-41ad-8ee6-fe934f1675db) |
| [`the-median-was-the-signal.html`](the-median-was-the-signal.html) | Margin of safety measured: drawdown alone fails and fails backwards, quality screens do not rescue it at two months, and at three years quality orders the median while the mean stays hostage to junk tails. Closes with what happened when the rules were traded as a book. | [artifact](https://claude.ai/code/artifact/d32675e0-0447-4485-add7-409285ec8558) |
...
| [`eighteen-percent.html`](eighteen-percent.html) | The drawdown rule on 18 ETFs and then on 134 companies, and what decides whether leverage pays. The 18% threshold carries the ETF result and does nothing on single stocks; the quality gate selects weakly (88th percentile of its null) and the cheapness gate backwards (28th). Carry is not the constraint — 80% of entries beat a 5% borrow — closeout is. The one survivor is speed: falls that arrive fast and market-wide recover in 179 sessions against 384, clear a quarter-block null at the 99th percentile, and survive removing 2008–09 and 2020. Closes with 154 years of total return showing that ratcheting leverage into a fall loses to its own inverse. | [artifact](https://claude.ai/code/artifact/d20037c8-0181-4a5f-bce3-9ae3043a12fc) |
| [`spy-drawdown-funding.html`](spy-drawdown-funding.html) | Reverse SPY leverage paired with a Treasury reserve: 10% annual profit harvesting, staged deployment at 20/30/50/80% flow-adjusted account drawdowns, and equal-budget monthly versus bimonthly contributions. Separates ending wealth, CAGR, XIRR and deposit-adjusted drawdown. | Local research page |
...
| [`quality-ladder-harvest.html`](quality-ladder-harvest.html) | Unlevered 80/20 SPY-Treasury drawdown ladder: point-in-time top-seven deployment, 20%-relative-excess harvesting, CAPE routing, SPY/static/ladder controls, allocation history, selections, harvests, and open holdings. | Local backtest page |
| [`dual-guard-quality-compounder-guide.md`](dual-guard-quality-compounder-guide.md) | Full operating manual for the 1x permanent SPY core, 20% Treasury ladder, NAV-gated new-capital injections, CAPE-based 1x/2x/3x tranche sizing, recovery reset, harvesting, safeguards and risks. | Local strategy guide |
| [`quality-ladder-cape-leverage.html`](quality-ladder-cape-leverage.html) | Dual-guard backtest: permanent SPY stays 1x, NAV decides when new capital may use leverage, CAPE selects 1x/2x/3x, and recovery resets injections to 1x; includes P&L, drawdowns, historical injections and controls. | Local backtest page |
