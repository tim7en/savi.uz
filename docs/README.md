...
| [`eighteen-percent.html`](eighteen-percent.html) | The drawdown rule on 18 ETFs and then on 134 companies. The 18% threshold carries the ETF result and does nothing on single stocks, where a 5% pullback performs identically; the quality gate selects weakly (88th percentile of its null) and the cheapness gate selects backwards (28th). Every arm loses to owning the market. | [artifact](https://claude.ai/code/artifact/d20037c8-0181-4a5f-bce3-9ae3043a12fc) |
